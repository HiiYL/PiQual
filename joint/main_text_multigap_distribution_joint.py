...
model = create_googlenet(embedding_layer, 'googlenet_aesthetics_multigap_weights2016-12-14 18:04:07.h5', heatmap=False)
...
checkpointer = ModelCheckpoint(filepath="joint_multigap_distribution_weights{}.h5".format(time_now), verbose=1, save_best_only=True)

reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.1,patience=3)

csv_logger = CSVLogger('joint_multigap_distribution_weights{}.log'.format(time_now))
...
aesthetics_pred, semantics_pred = model.predict([X_test, X_test_text])
