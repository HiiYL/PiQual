...
checkpointer = ModelCheckpoint(filepath="logs/multigap_distribution_weights{}.h5".format(time_now), verbose=1, save_best_only=True)

reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.1,patience=3)

csv_logger = CSVLogger('logs/multigap_distribution_weights{}.log'.format(time_now))
...
plot(model, to_file='model_joint_multigap_distribution.png')
...
aesthetics_pred = model.predict([X_test, X_test_text])
