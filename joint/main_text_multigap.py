...
checkpointer = ModelCheckpoint(filepath="googlenet_aesthetics_multigap_weights{}.h5".format(time_now), verbose=1, save_best_only=True)

reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.1,patience=3)

csv_logger = CSVLogger('training_multigap_aesthetics{}.log'.format(time_now))
...
plot(model, to_file='model_multigap.png')
