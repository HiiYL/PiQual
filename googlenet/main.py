...
def create_googlenet(weights_path=None, heatmap=False):
    ...
    main_output = Dense(2, activation = 'softmax', name="main_output")(pool5_drop_7x7_s1)
...
checkpointer = ModelCheckpoint(filepath="googlenet_original_aesthetics_weights.h5", verbose=1, save_best_only=True)
